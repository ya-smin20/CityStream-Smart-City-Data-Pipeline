...
def main():
    spark = SparkSession.builder.appName('CityStreamSmart')\
    ...
    q1 = streamWriter(input=vehicleDF,
                      checkpointFolder='s3a://smart-streaming-data/checkpoints/vehicle_data',
                      output='s3a://smart-streaming-data/data/vehicle_data')
    
    q2 = streamWriter(input=gpsDF,
                      checkpointFolder='s3a://smart-streaming-data/checkpoints/gps_data',
                      output='s3a://smart-streaming-data/data/gps_data')
    
    q3 = streamWriter(input=trafficDF,
                      checkpointFolder='s3a://smart-streaming-data/checkpoints/traffic_data',
                      output='s3a://smart-streaming-data/data/traffic_data')
    
    q4 = streamWriter(input=weatherDF,
                      checkpointFolder='s3a://smart-streaming-data/checkpoints/weather_data',
                      output='s3a://smart-streaming-data/data/weather_data')
    
    q5 = streamWriter(input=emergencyDF,
                      checkpointFolder='s3a://smart-streaming-data/checkpoints/emergency_data',
                      output='s3a://smart-streaming-data/data/emergency_data')
